          ...
          <div class="row layout-payment ">
                  ...
                  <form class="woocommerce-cart-form" >
                      <div class="cart-wrapper sm-touch-scroll">
                          <table class="table">
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row"><img src="../img/list-watch/watch-1.jpg" class="img-cart-detail" alt=""></th>
                                      <td>639,000 vnđ</td>
                                      <td>
                                          <span>
                          ...
                          <div class="button-cart-shopping">
                              <span>
                                  <button><i class="fa fa-arrow-left"></i>Tiếp Tục Xem Sản Phẩm</button>
                              </span>
                              <span>
              ...
              <div class="col-5">
                  <div class="cart_totals">
                      ...
                      <div>
                          <button class="btn btn-success make-payment">Tiến Hành Thanh Toán</button>
                      </div>
                      ...
                      <table class="table">
                          <tfoot>
                              ...
                              <tr>
                                  <th>
                                      <input type="text" placeholder="Nhập Mã Ưu Đãi" class="input-code">
                                  </th>
                              </tr>
                          </tfoot>
                      </table>
